...
namespace Comman.Dapper.Linq.Extension.Dapper
{
    ...
    /// </summary>
    internal sealed class TableValuedParameter : Comman.Dapper.Linq.Extension.Dapper.SqlMapper.ICustomQueryParameter
    {
        ...
        void Comman.Dapper.Linq.Extension.Dapper.SqlMapper.ICustomQueryParameter.AddParameter(IDbCommand command, string name)
        {
...
#pragma warning disable 0618
            parameter.Value = Comman.Dapper.Linq.Extension.Dapper.SqlMapper.SanitizeParameterValue(table);
#pragma warning restore 0618
            if (string.IsNullOrEmpty(typeName) && table != null) typeName = table.GetTypeName();
