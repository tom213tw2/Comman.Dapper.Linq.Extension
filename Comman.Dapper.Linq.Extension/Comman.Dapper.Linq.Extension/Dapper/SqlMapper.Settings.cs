...
namespace Comman.Dapper.Linq.Extension.Dapper
{
    public static partial class SqlMapper
    {
        ...
        public static class Settings
        {
            ...
            /// </summary>
            /// <remarks>
            ///     Note that a consequence of enabling this option is that errors that happen <b>after</b> the first select may
            ///     not be reported
            /// </remarks>
            ...
            /// <summary>
            ///     If set (non-negative), when performing in-list expansions of integer types ("where id in @ids", etc), switch to a
            ///     string_split based
            ///     operation if there are more than this many elements. Note that this feautre requires SQL Server 2016 /
            ///     compatibility level 130 (or above).
            /// </summary>
