...
namespace Kogel.Dapper.Extension
{
    ...
    public static partial class SqlMapper
    {
        ...
        private static readonly Regex smellsLikeOleDb =
                new Regex(@"(?<![\p{L}\p{N}@_])[?@:](?![\p{L}\p{N}@_])",
                    RegexOptions.IgnoreCase | RegexOptions.Multiline | RegexOptions.CultureInvariant |
                    RegexOptions.Compiled),
            literalTokens = new Regex(@"(?<![\p{L}\p{N}_])\{=([\p{L}\p{N}_]+)\}",
                RegexOptions.IgnoreCase | RegexOptions.Multiline | RegexOptions.CultureInvariant |
                RegexOptions.Compiled),
            pseudoPositional = new Regex(@"\?([\p{L}_][\p{L}\p{N}_]*)\?",
                RegexOptions.IgnoreCase | RegexOptions.CultureInvariant | RegexOptions.Compiled);

        internal static readonly MethodInfo format =
            typeof(SqlMapper).GetMethod("Format", BindingFlags.Public | BindingFlags.Static);
        ...
        private static readonly Dictionary<TypeCode, MethodInfo> toStrings = new[]
        {
            ...
            x => x.GetPublicInstanceMethod(nameof(ToString), new[] { typeof(IFormatProvider) }));

        private static readonly MethodInfo StringReplace =
                typeof(string).GetPublicInstanceMethod(nameof(string.Replace),
                    new[] { typeof(string), typeof(string) }),
            InvariantCulture = typeof(CultureInfo)
                .GetProperty(nameof(CultureInfo.InvariantCulture), BindingFlags.Public | BindingFlags.Static)
                .GetGetMethod();
        ...
        ///     临时属性映射
        /// </summary>
        [ThreadStatic] private static Hashtable _temporaryTypeMaps = new Hashtable();
        ...
        public static AopProvider Aop => AopProvider.Get();
        ...
        {
            var data = _queryCache.Select(pair =>
                Tuple.Create(pair.Key.connectionString, pair.Key.sql, pair.Value.GetHitCount()));
...
#pragma warning restore 618
        ...
        public static DbType LookupDbType(Type type, string name, bool demand, out ITypeHandler handler)
        {
            ...
            if (type.IsEnum() && !typeMap.ContainsKey(type)) type = Enum.GetUnderlyingType(type);
            ...
            if (demand)
                throw new NotSupportedException(
                    $"The member {name} of type {type.FullName} cannot be used as a parameter value");
            return DbType.Object;
        }
        ...
        {
            var command = new CommandDefinition(cnn, sql, param, transaction, commandTimeout, commandType,
                CommandFlags.None, default, isExcludeUnitOfWork);
            ...
            int? commandTimeout = null, CommandType? commandType = null, bool isExcludeUnitOfWork = false)
        {
            if (type == null) throw new ArgumentNullException(nameof(type));
            var command = new CommandDefinition(cnn, sql, param, transaction, commandTimeout, commandType,
                CommandFlags.None, isExcludeUnitOfWork: isExcludeUnitOfWork);
        ...
        private static IDataReader ExecuteReaderWithFlagsFallback(IDbCommand cmd, bool wasClosed,
        ...
        private static IEnumerable<TReturn> MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh,
            TReturn>(
            ...
            bool finalize)
        {
            ...
            try
            {
                if (reader == null)
                {
                    ...
                    if (wasClosed) command.Connection.Open();
                    ownedReader = ExecuteReaderWithFlagsFallback(ownedCommand, wasClosed,
                        CommandBehavior.SequentialAccess | CommandBehavior.SingleResult);
                    reader = ownedReader;
                }
                ...
                if (mapIt != null)
                {
                    while (reader.Read()) yield return mapIt(reader);
                    if (finalize)
                    {
                        while (reader.NextResult())
                        {
        ...
        private static Func<IDataReader, TReturn> GenerateMapper<TFirst, TSecond, TThird, TFourth, TFifth, TSixth,
            TSeventh, TReturn>(Func<IDataReader, object> deserializer, Func<IDataReader, object>[] otherDeserializers,
            object map)
        {
            switch (otherDeserializers.Length)
            {
                case 1:
                    return r => ((Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>)map)(
                        (TFirst)deserializer(r), (TSecond)otherDeserializers[0](r), default, default, default, default,
                        default);
                case 2:
                    return r => ((Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>)map)(
                        (TFirst)deserializer(r), (TSecond)otherDeserializers[0](r), (TThird)otherDeserializers[1](r),
                        default, default, default, default);
                case 3:
                    return r => ((Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>)map)(
                        (TFirst)deserializer(r), (TSecond)otherDeserializers[0](r), (TThird)otherDeserializers[1](r),
                        (TFourth)otherDeserializers[2](r), default, default, default);
                case 4:
                    return r => ((Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>)map)(
                        (TFirst)deserializer(r), (TSecond)otherDeserializers[0](r), (TThird)otherDeserializers[1](r),
                        (TFourth)otherDeserializers[2](r), (TFifth)otherDeserializers[3](r), default, default);
                case 5:
                    return r => ((Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>)map)(
                        (TFirst)deserializer(r), (TSecond)otherDeserializers[0](r), (TThird)otherDeserializers[1](r),
                        (TFourth)otherDeserializers[2](r), (TFifth)otherDeserializers[3](r),
                        (TSixth)otherDeserializers[4](r), default);
                case 6:
                    return r => ((Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>)map)(
                        (TFirst)deserializer(r), (TSecond)otherDeserializers[0](r), (TThird)otherDeserializers[1](r),
                        (TFourth)otherDeserializers[2](r), (TFifth)otherDeserializers[3](r),
                        (TSixth)otherDeserializers[4](r), (TSeventh)otherDeserializers[5](r));
                default:
                    throw new NotSupportedException();
            }
        }
            ...
            Func<object[], TReturn> map)
        {
            return r =>
            {
                ...
                for (var i = 1; i < length; ++i) objects[i] = otherDeserializers[i - 1](r);
        ...
        {
            if (startIdx == reader.FieldCount) throw MultiMapException(reader);
            ...
            cmd.CommandText = pseudoPositional.Replace(cmd.CommandText, match =>
            {
                ...
                if (parameters.TryGetValue(key, out var param))
                {
                    if (firstMatch)
                    {
                        firstMatch = false;
                        cmd.Parameters
                            .Clear(); // only clear if we are pretty positive that we've found this pattern successfully
                    }
            ...
            int length, bool returnNullIfFirstMissing)
        {
            ...
            if (length == -1) length = fieldCount - startBound;

            if (fieldCount <= startBound) throw MultiMapException(reader);
            ...
            return
                r =>
                {
                    ...
                    if (returnNullIfFirstMissing)
                    {
                        ...
                        if (values[0] is DBNull) return null;
                    }
                ...
                if (list != null && !viaSplit)
                {
                    ...
                    foreach (var item in list)
                    {
                        if (++count == 1) // first item: fetch some type info
                        {
                            ...
                            if (!isDbString) dbType = LookupDbType(item.GetType(), "", true, out var handler);
                        }
                        ...
                        else
                        {
                            ...
                            if (isString)
                            {
                                ...
                                if (item != null && ((string)item).Length > DbString.DefaultLength) listParam.Size = -1;
                            }
                            ...
                            if (listParam.DbType != dbType) listParam.DbType = dbType;
        ...
        private static bool TryStringSplit<T>(ref IEnumerable<T> list, int splitAt, string namePrefix,
            IDbCommand command, string colType, bool byPosition,
            Action<StringBuilder, T> append)
        {
            ...
            using (var iter = typed.GetEnumerator())
            {
                if (iter.MoveNext())
                {
                    ...
                    while (iter.MoveNext()) append(sb.Append(','), iter.Current);
                    val = sb.ToString();
                }
                else
                {
...
#pragma warning restore 0618
        ...
        private static List<IMemberMap> GetValueTupleMembers(Type type, string[] names)
        {
            ...
            for (var i = 0; i < names.Length; i++)
            {
                ...
                result.Add(field == null
                    ? null
                    : new SimpleMemberMap(string.IsNullOrWhiteSpace(names[i]) ? name : names[i], field));
            }
            ...
            bool removeUnused, IList<LiteralToken> literals)
        {
            ...
            var dm = new DynamicMethod("ParamInfo" + Guid.NewGuid(), null, new[] { typeof(IDbCommand), typeof(object) },
                type, true);
            ...
            il.EmitCall(OpCodes.Callvirt, typeof(IDbCommand).GetProperty(nameof(IDbCommand.Parameters)).GetGetMethod(),
            ...
            if (ctors.Length == 1 && propsList.Count == (ctorParams = ctors[0].GetParameters()).Length)
            {
                ...
                else
                {
                    ...
                    foreach (var param in ctorParams) positionByName[param.Name] = param.Position;
            ...
            if (filterParams) props = FilterParameters(props, identity.sql);
...
#pragma warning restore 618
                if (dbType == DynamicParameters.EnumerableMultiParameter)
                {
                    ...
                    il.EmitCall(OpCodes.Call, typeof(SqlMapper).GetMethod(nameof(PackListParameters)),
                        null); // stack is [parameters]
                    continue;
                }
                ...
                if (checkForDuplicates)
                {
                    ...
                    il.EmitCall(OpCodes.Call, typeof(SqlMapper).GetMethod(nameof(FindOrAddParameter)),
                        null); // stack is [parameters] [parameter]
                }
                else
                {
                    ...
                    il.Emit(OpCodes.Ldstr,
                        prop.Name); // stack is now [parameters] [parameters] [parameter] [parameter] [name]
                    il.EmitCall(OpCodes.Callvirt,
                        typeof(IDataParameter).GetProperty(nameof(IDataParameter.ParameterName)).GetSetMethod(),
                        null); // stack is now [parameters] [parameters] [parameter]
                }

                if (dbType != DbType.Time &&
                    handler == null) // https://connect.microsoft.com/VisualStudio/feedback/details/381934/sqlparameter-dbtype-dbtype-time-sets-the-parameter-to-sqldbtype-datetime-instead-of-sqldbtype-time
                {
                    il.Emit(OpCodes.Dup); // stack is now [parameters] [[parameters]] [parameter] [parameter]
                    if (dbType == DbType.Object && prop.PropertyType == typeof(object)) // includes dynamic
                    {
                        ...
                        il.Emit(OpCodes
                            .Ldloc_0); // stack is now [parameters] [[parameters]] [parameter] [parameter] [typed-param]
                        il.Emit(callOpCode,
                            prop.GetGetMethod()); // stack is [parameters] [[parameters]] [parameter] [parameter] [object-value]
                        il.Emit(OpCodes.Call,
                            typeof(SqlMapper).GetMethod(nameof(GetDbType),
                                BindingFlags.Static |
                                BindingFlags
                                    .Public)); // stack is now [parameters] [[parameters]] [parameter] [parameter] [db-type]
                    }
                    else
                    {
                        // constant value; nice and simple
                        EmitInt32(il,
                            (int)dbType); // stack is now [parameters] [[parameters]] [parameter] [parameter] [db-type]
                    }
                ...
                EmitInt32(il,
                    (int)ParameterDirection
                        .Input); // stack is now [parameters] [[parameters]] [parameter] [parameter] [dir]
                il.EmitCall(OpCodes.Callvirt,
                    typeof(IDataParameter).GetProperty(nameof(IDataParameter.Direction)).GetSetMethod(),
                    null); // stack is now [parameters] [[parameters]] [parameter]
                ...
                il.Emit(OpCodes
                    .Ldloc_0); // stack is now [parameters] [[parameters]] [parameter] [parameter] [typed-param]
                il.Emit(callOpCode,
                    prop.GetGetMethod()); // stack is [parameters] [[parameters]] [parameter] [parameter] [typed-value]
                bool checkForNull;
                if (prop.PropertyType.IsValueType())
                {
                    ...
                    il.Emit(OpCodes.Box,
                        propType); // stack is [parameters] [[parameters]] [parameter] [parameter] [boxed-value]
                    if (callSanitize)
                    {
                ...
                if (checkForNull)
                {
                    ...
                    if (prop.PropertyType == typeof(string))
                    {
                        ...
                        il.EmitCall(OpCodes.Callvirt, typeof(string).GetProperty(nameof(string.Length)).GetGetMethod(),
                            null); // [string] [length]
...
#pragma warning restore 618
                ...
                {
                    il.EmitCall(OpCodes.Callvirt,
                        typeof(IDataParameter).GetProperty(nameof(IDataParameter.Value)).GetSetMethod(),
                        null); // stack is now [parameters] [[parameters]] [parameter]
                }
                ...
                if (prop.PropertyType == typeof(string))
                {
                    ...
                    il.EmitCall(OpCodes.Callvirt,
                        typeof(IDbDataParameter).GetProperty(nameof(IDbDataParameter.Size)).GetSetMethod(),
                        null); // stack is now [parameters] [[parameters]] [parameter]
                ...
                else
                {
                    ...
                    // blindly add
                    il.EmitCall(OpCodes.Callvirt, typeof(IList).GetMethod(nameof(IList.Add)),
                        null); // stack is now [parameters]
                    ...
                    if (prop != null)
                    {
                        ...
                        switch (typeCode)
                        {
                            ...
                            case TypeCode.Decimal:
                                ...
                                il.EmitCall(OpCodes.Call, InvariantCulture,
                                    null); // command, sql, ref-to-value, culture
        ...
        {
            Aop.InvokeExecuting(ref command);
            var paramReader = GetParameterReader(command.Connection, ref command);
            cmd = null;
...
#pragma warning disable 618
            ...
            if (type == typeof(char?)) return r => ReadNullableChar(r.GetValue(index));
            if (type.FullName == LinqBinary) return r => Activator.CreateInstance(type, r.GetValue(index));
#pragma warning restore 618
        ...
        private static T Parse<T>(object value)
        {
            ...
            if (typeHandlers.TryGetValue(type, out var handler)) return (T)handler.Parse(type, value);
        ...
        )
        {
            ...
            var dm = new DynamicMethod("Deserialize" + Guid.NewGuid(), returnType, new[] { typeof(IDataReader) }, type,
                true);
            var il = dm.GetILGenerator();
            il.DeclareLocal(typeof(int));
            ...
            if (reader.FieldCount <= startBound) throw MultiMapException(reader);
            ...
            else
            {
                ...
                for (var i = startBound; i < startBound + length; i++) types[i - startBound] = reader.GetFieldType(i);
                ...
                if (explicitConstr != null)
                {
                    ...
                    if (supportInitialize)
                    {
                        ...
                        il.EmitCall(OpCodes.Callvirt,
                            typeof(ISupportInitialize).GetMethod(nameof(ISupportInitialize.BeginInit)), null);
                    }
#endif
                }
                else
            ...
            else if (specializedConstructor == null) il.Emit(OpCodes.Ldloc_1); // [target]
                ...
                if (item != null)
                {
                    ...
                    else
                    {
                        ...
                        il.Emit(OpCodes.Isinst,
                            typeof(DBNull)); // stack is now [target][target][value-as-object][DBNull or null]
                        ...
                        else if (memberType.FullName == LinqBinary)
                        {
                            ...
                            il.Emit(OpCodes.Newobj,
                                memberType.GetConstructor(new[]
                                    { typeof(byte[]) })); // stack is now [target][target][binary]
                        }
                        else
                        {
...
#pragma warning restore 618
                    ...
                    if (specializedConstructor == null)
                    {
                        ...
                        if (item.Property != null)
                            il.Emit(type.IsValueType() ? OpCodes.Call : OpCodes.Callvirt,
                                DefaultTypeMap.GetPropertySetter(item.Property, type));
                        else
            ...
            {
                if (specializedConstructor != null) il.Emit(OpCodes.Newobj, specializedConstructor);
                ...
                if (supportInitialize)
                {
                    il.Emit(OpCodes.Ldloc_1);
                    il.EmitCall(OpCodes.Callvirt,
                        typeof(ISupportInitialize).GetMethod(nameof(ISupportInitialize.EndInit)), null);
                }
#endif
            }
            ...
            il.EmitCall(OpCodes.Call, typeof(SqlMapper).GetMethod(nameof(ThrowDataException)), null);
        ...
        private static void FlexibleConvertBoxedFromHeadOfStack(ILGenerator il, Type from, Type to, Type via)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    il.EmitCall(OpCodes.Call, typeof(Type).GetMethod(nameof(Type.GetTypeFromHandle)),
                        null); // stack is now [target][target][value][member-type]
                    il.EmitCall(OpCodes.Call,
