...
namespace Kogel.Dapper.Extension.Extension
{
    ...
    public static class NavigationExtension
    {
        ...
        {
            var typeList = new List<Type> { typeof(T) };
            for (var i = 0; i < 6; i++)
                if (provider.JoinList.Count > i)
                    typeList.Add(provider.JoinList[i].IsDto
                        ? provider.JoinList[i].DtoType
                        : provider.JoinList[i].TableType);
                else
        ...
        /// <returns></returns>
        public static T QueryFirstOrDefaults<T>(this IDbConnection dbCon, SqlProvider provider,
            IDbTransaction transaction)
        {
            ...
            return dbCon.QueryFirstOrDefault<T>(provider.SqlString, provider.Params, transaction,
                isExcludeUnitOfWork: provider.IsExcludeUnitOfWork);
        }
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static Task<T> QueryFirstOrDefaultAsyncs<T>(this IDbConnection dbCon, SqlProvider provider,
            IDbTransaction transaction)
        {
            if (provider.JoinList.Any(x => x.Action == JoinAction.Navigation && x.IsMapperField))
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static IEnumerable<T> Querys<T>(this IDbConnection dbCon, SqlProvider provider,
            IDbTransaction transaction)
        {
            if (provider.JoinList.Any(x => x.Action == JoinAction.Navigation && x.IsMapperField))
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static Task<IEnumerable<T>> QueryAsyncs<T>(this IDbConnection dbCon, SqlProvider provider,
            IDbTransaction transaction)
        {
            if (provider.JoinList.Any(x => x.Action == JoinAction.Navigation && x.IsMapperField))
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static GridReader QueryMultiples<T>(this IDbConnection dbCon, SqlProvider provider,
            IDbTransaction transaction)
        {
        ...
        /// <param name="transaction"></param>
        /// <returns></returns>
        public static async Task<T> QuerySinglesAsync<T>(this IDbConnection dbCon, SqlProvider provider,
            IDbTransaction transaction)
        {
        ...
        /// <returns></returns>
        public static DataSet QueryDataSets(this IDbConnection dbCon, SqlProvider provider, IDbTransaction transaction,
        ...
        /// <param name="dataAdapter"></param>
        /// <returns></returns>
        public static async Task<DataSet> QueryDataSetsAsync(this IDbConnection dbCon, SqlProvider provider,
            IDbTransaction transaction,
            IDbDataAdapter dataAdapter)
        {
            if (dataAdapter == null)
